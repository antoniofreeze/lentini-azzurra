...
// ---------- Candidate data ----------
const CANDIDATES = [
  { order:  1, name: "FERRARO SALVATORE detto \"SALVO\"", cv: "assets/docs/cv-azzurra-01.pdf", casellario: "assets/docs/casellario-azzurra-combinato.pdf" },
  { order:  2, name: "ADDAMO MARIA CRISTINA detta \"CRISTINA\"", cv: "assets/docs/cv-azzurra-02.pdf", casellario: "assets/docs/casellario-azzurra-combinato.pdf" },
  { order:  3, name: "BARRETTA MARCO", cv: "assets/docs/cv-azzurra-03.pdf", casellario: "assets/docs/casellario-azzurra-combinato.pdf" },
  { order:  4, name: "BUDA GIUSY", cv: "assets/docs/cv-azzurra-04.pdf", casellario: "assets/docs/casellario-azzurra-combinato.pdf" },
  { order:  5, name: "CAPPELLO LEANDRA", cv: "assets/docs/cv-azzurra-05.pdf", casellario: "assets/docs/casellario-azzurra-combinato.pdf" },
  { order:  6, name: "CARNAZZO ENRICO", cv: "assets/docs/cv-azzurra-06.pdf", casellario: "assets/docs/casellario-azzurra-combinato.pdf" },
  { order:  7, name: "CICERO PIETRO", cv: "assets/docs/cv-azzurra-07.pdf", casellario: "assets/docs/casellario-azzurra-combinato.pdf" },
  ...
  { order: 15, name: "SAGGIO FABIO detto \"DARIO SAGGIO\"", cv: "assets/docs/cv-azzurra-15.pdf", casellario: "assets/docs/casellario-azzurra-combinato.pdf" },
  { order: 16, name: "VINTALORO VALERIA", cv: "assets/docs/cv-azzurra-16.pdf", casellario: "assets/docs/casellario-azzurra-combinato.pdf" },
];
